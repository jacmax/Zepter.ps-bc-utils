function GetNavExtensions {
    $NavExtension =
        @(
            ...
            [pscustomobject]@{name="Common"          ;version= '0.1.0.5'},
            [pscustomobject]@{name="SalesItem"       ;version= '0.1.0.3'},
            [pscustomobject]@{name="Representative"  ;version= '0.1.0.2'},
            [pscustomobject]@{name="SalesContract"   ;version= '0.1.0.5'},
            [pscustomobject]@{name="Payment"         ;version= '0.1.0.4'},
