function GetNavExtensions {
    ...
    @(
        ...
        [pscustomobject]@{name = "Common"          ; version = '20.0.10.10' },
        ...
        [pscustomobject]@{name = "DataMigration"   ; version = '20.0.10.12' },
        [pscustomobject]@{name = "PersonalVoucher" ; version = '20.0.10.2' },
        [pscustomobject]@{name = "Commission"      ; version = '20.0.10.3' },
        [pscustomobject]@{name = "GDPR"            ; version = '20.0.10.1' },
        [pscustomobject]@{name = "ImportPurchase"  ; version = '20.0.10.1' },
        ...
        [pscustomobject]@{name = "SIIntegration"   ; version = '20.0.10.1' },
        [pscustomobject]@{name = "MKIntegration"   ; version = '20.0.10.11' },
