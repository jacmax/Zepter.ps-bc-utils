function GetNavExtensions {
    ...
    @(
        ...
        [pscustomobject]@{name = "Common"          ; version = '20.0.9.2' },
        [pscustomobject]@{name = "SalesItem"       ; version = '20.0.9.2' },
        [pscustomobject]@{name = "Representative"  ; version = '20.0.9.0' },
        [pscustomobject]@{name = "SalesContract"   ; version = '20.0.9.5' },
        [pscustomobject]@{name = "Payment"         ; version = '20.0.9.0' },
        [pscustomobject]@{name = "DataMigration"   ; version = '20.0.9.0' },
        [pscustomobject]@{name = "PersonalVoucher" ; version = '20.0.9.0' },
        [pscustomobject]@{name = "Commission"      ; version = '20.0.9.0' },
        ...
        [pscustomobject]@{name = "HoldingReport"   ; version = '20.0.9.0' },
        [pscustomobject]@{name = "ITIntegration"   ; version = '20.0.9.0' },
        [pscustomobject]@{name = "SIIntegration"   ; version = '20.0.9.0' },
